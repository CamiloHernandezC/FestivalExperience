...
<div id="welcome" class="flex-center position-ref full-height">
    <div class="content">
        <div class="title">
            ...
            <a id="schedule-courtesy" href="https://api.whatsapp.com/send/?phone=573159142914<&text=Hola,%20quiero%20informacion%20de%20Festival%20Experience&app_absent=0" style="background: linear-gradient(90deg, rgba(67,0,36,1) 0%, rgba(67,5,68,1) 72%, rgba(87,6,88,1) 100%);" class="btn ml-auto mr-auto" target="_blank">
                    ¡Más Informacion!
            </a>
...
<div class="section text-center d-block">
    <h1 class="mb-5" style=" font-family: 'Cinzel'!important; font-weight: 200!important; font-size: 13vw">Experiencias</h1>
...
<footer style="margin: 0" class="footer-distributed">
    ...
    <div class="footer-center">
        ...
        <div>
            ...
            <p><a href="mailto:contacto@girlpower.com.co">contacto@festivalexperience.com.co</a></p>
        </div>
